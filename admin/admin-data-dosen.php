    ...
    <div id="app-layout">
        ...
        <div class="modal fade" id="modalEditDosen" tabindex="-1" aria-labelledby="modalEditDosenLabel">
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form id="formDosen" action="controller/data-dosen-controller/edit-dosen.php" method="POST"
                            enctype="multipart/form-data">
                            <div class="row g-3">
                                ...
                                <div class="col-xxl-12">
                                    <div>
                                        ...
                                        <input type="file" class="form-control" id="edit-foto" name="edit-foto"
                                            accept=".jpg,.jpeg,.png">
                                    </div>
                                </div><!--end col-->
        ...
        <div class="modal fade" id="modalGantiPassword" tabindex="-1" aria-labelledby="modalGantiPasswordLabel">
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form id="formGantiPassword" action="controller/data-dosen-controller/edit-pass-dosen.php"
                            method="POST">
                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-xxl-12">
                                    ...
                                    <input type="password" class="form-control" id="confirmPassword"
                                        name="confirmPassword" placeholder="Masukkan Kembali Password" required>
                                </div>
                                <div class="col-lg-12">
                                    <div class="hstack gap-2 justify-content-end">
                                        <button type="button" class="btn btn-light"
        ...
        <script>
            function openFoto(url) {
                var fotodosen = document.getElementById('foto-dosen');
                fotodosen.src = url;
            }
        </script>
