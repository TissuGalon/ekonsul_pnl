                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-striped mb-0">
                                            ...
                                            <tbody>
                                                ...
                                                $conn = getConnection();
                                                $no = 1;
                                                $student_id = $_SESSION['mahasiswa_data']['student_id'];
                                                $query = mysqli_query($conn, "SELECT * 
                                                FROM konseling
                                                JOIN dosen 
                                                ON konseling.lecturer_id = dosen.lecturer_id WHERE status != 'Dibatalkan' AND student_id = $student_id;
                                                    ");
                                                while ($row = mysqli_fetch_array($query)) {
                                                    ...
                                                    ?>
                                                                                                                                                                    <tr>
                                                                                                                                                                        ...
                                                                                                                                                                        <td><?php echo $row['tujuan_konseling'] ?></td>
                                                                                                                                                                        <td><b class="text-primary"><?php echo $row['fullname'] ?> </b> <br> <?php echo $row['nip'] ?></td>
                                                                                                                                                                        <td><?php echo $row['jenis_konseling'] ?></td>
                                                                                                                                                                        <td><b><?php echo $row['tanggal_konseling'] ?></b> <br> <?php echo $row['waktu_mulai'] ?> -  <?php echo $row['waktu_selesai'] ?></td>
                                                                                                                                                                        <td>
                                                                                                                                                                            <div class="badge text-bg-primary"><?php echo $row['status'] ?> </div>
                                                                                                                                                                        </td>
                                                                                                                                                                        <td class="d-flex">
